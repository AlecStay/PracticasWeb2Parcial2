...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { torneoId, equipo1Id, equipo2Id, golesEquipo1, golesEquipo2, observacion, entornoId } = req.body; // Agrega entornoId al cuerpo de la solicitud
    try {
        const newPartido = yield prisma.partido.create({
            data: { torneoId, equipo1Id, equipo2Id, golesEquipo1, golesEquipo2, observacion, Estado: 'Activo', entornoId } // Incluye entornoId al crear un nuevo partido
        });
        res.json(newPartido);
    }
    catch (error) {
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const deletedPartido = yield prisma.partido.update({
            where: { idpartido: parseInt(id, 10) },
